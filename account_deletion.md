...
В приложении перейдите в **Настройки → Удалить аккаунт**. После подтверждения действия автоматически откроется почтовый клиент с уже заполненной темой и текстом письма.
...
- Если автомобиль участвовал хотя бы в одном бронировании, то при удалении он **пропадает из интерфейса**, но **сохраняется в системе** как «снепшот» для целостности истории бронирований.  

---

**Если почтовый клиент не открылся автоматически:**  
Отправьте письмо вручную на **support@wexy.kz** с темой **«Запрос на удаление аккаунта Wexy»** и укажите в теле письма ваши Username, Имя, Фамилию и Номер телефона.  

По всем вопросам: **support@wexy.kz** или **+7 700 244 68 31**
