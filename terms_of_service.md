...
## 1. Общие положения  
1. Настоящие Условия использования (далее — «Условия») регулируют отношения между ТОО «Wexy hub» (далее — «Компания», «Wexy») и Пользователем при использовании мобильного приложения **Wexy**.  
